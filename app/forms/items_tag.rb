class ItemsTag
  ...
  def update
    ...
    item.update(name: name, image: image.blob, description: description, price: price, category_id: category_id, condition_id: condition_id, shipping_fee_person_id: shipping_fee_person_id, region_id: region_id, date_ish_id: date_ish_id, user_id: user_id, id: item_id)
    tag = Tag.where(tag_name: tag_name).first_or_initialize
